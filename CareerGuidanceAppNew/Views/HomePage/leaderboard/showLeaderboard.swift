...
class showLeaderboard: UICollectionViewCell {
    ...
    private func build() {
        ...
        let iconBg = makeIconBubble(systemName: "list.number", color: .accentTeal)
        ...
        subLabel.text = "See how you rank"
    ...
    @IBAction func leaderboardact(_ sender: Any) { onChevronTapped?() }
}
